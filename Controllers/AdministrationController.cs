...
namespace E_CounsellingWebApplication.Controllers
{
    ...
    public class AdministrationController : Controller
    {
        ...
        public async Task<IActionResult> ManageUserClaims(UserClaimsViewModel model)
        {
            ...
            //if selected true value is stored
        ...
        public async Task<IActionResult> DeleteUser(string id)
        {
            ...
            {
                IdentityResult deletionResult = await userManager.RemoveFromRoleAsync(user, "User");
        ...
        public async Task<IActionResult> EditUsersInRole(List<UserRoleViewModel> model, string roleId)
        {
            ...
            for (int i = 0; i < model.Count; i++)
            {
                ...
                //if the user is selected and he is not already added to this role
                if (model[i].IsSelected && !(await userManager.IsInRoleAsync(user, role.Name)))
                {
                    result = await userManager.AddToRoleAsync(user, role.Name);
                }
                //if user is not selected and already in the role we remove him
        ...
        public async Task<IActionResult> EditUser(EditUserViewModel model)
        {
            ...
            else
            {
                ...
                //var resultt = await userManager.CreateAsync(user, model.Password);
        ...
        public async Task<IActionResult> Statistics()
        {
            ...
            foreach (var user in users)
            {
                ...
                if (rolename.FirstOrDefault()=="Counselor")
                {
                    counselorscount++;
                }
                else
            ...
            var appointmentlist =context.Appointments.ToList();
